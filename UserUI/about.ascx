...
<html lang="en">
    ...
    <body>
        ...
        <nav style="background-color: #000">
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a class="nav-active" href="VeCLM.aspx">VỀ C-L-M</a>
                    </li>
                    <li>
        ...
        <div class="about__clm">
            <div class="about__section">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-4">
                            <h2 class="about__section--heading">Về C-L-M</h2>
                            <div
                                class="icon-contact about__section--icon-contact"
                            >
                            ...
                            <p class="about__section--date">
                                Ngày đăng: 09:09 - 09/09/2023
                            </p>
                            <div class="about__section--desc">
                                <h3>
                                    <strong class="about__section--title"
                                        >Giá trị cốt lõi</strong
                                    >
                                </h3>
                                <ul>
                                    <li>
                                        <b>Đạo đức -</b> Trung thực, thẳng thắn
                                        và hồn nhiên.
                                    </li>
                                    <li>
                                        <b>Chuyên nghiệp -</b> luôn hướng tới sự
                                        hoàn hảo về sản phẩm, trải nghiệm khách
                                        hàng.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-8 about__section--images">
                            <figure>
                                <img
                                    src="./assets/img/nhoncao.jpg"
                                    alt=""
                                    class="admin"
                                />
                                <figcaption class="figcaption-admin">
                                    Nhơn Cao
                                </figcaption>
                            </figure>
                            <figure>
                                <img
                                    src="./assets/img/thanhluan.jpg"
                                    alt=""
                                    class="admin"
                                />
                                <figcaption class="figcaption-admin">
